...
type UserResponse struct {
	...
	ImagePath     *string                `protobuf:"bytes,10,opt,name=image_path,json=imagePath,proto3,oneof" json:"image_path,omitempty"`
...
func (x *UserResponse) GetImagePath() string {
...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x04user\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\"\x8a\x03\n" +
	...
	"\n" +
	"image_path\x18\n" +
	" \x01(\tH\x00R\timagePath\x88\x01\x01B\r\n" +
	"\v_image_path\"9\n" +
	"\rUsersResponse\x12(\n" +
