...
func TestController_Archive(t *testing.T) {
	...
	testTable := []struct {
	...
	}{
		{
			...
			expectedResponseBody: `{"id":1,"version":2,"user_id":1,"title":"Title","description":"","price":0,"category_id":0,"status":"archived","advert_images":{"count":0,"images":[]},"created_at":"2024-01-01T12:00:00Z","updated_at":"2024-01-01T12:00:00Z"}`,
		},
		{
	...
	for _, testCase := range testTable {
		t.Run(testCase.name, func(t *testing.T) {
			...
			r := httptest.NewRequest(http.MethodPost, "/adverts/"+testCase.idPathValue+"/archive", nil)
